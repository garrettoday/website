---
title: "Data Analysis for O'Day and Karpicke (2020) E1"
output: 
  html_notebook:
    toc: yes
    toc_depth: 3
...
# export plot
  ...
  plots <-   grid.arrange(E1.verbPlot, E1.higherPlot, E1.recall3Plot, ncol = 3) # plot preview
  
ggsave("test.png", plots, width = 6*3, height = 2.75*3, dpi = 600)  
